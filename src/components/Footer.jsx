...
const Footer = () => {
    ...
    return (
        <div className="bg-[#1D91AA] text-white flex w-full flex-col p-6">
            ...
            <div className="flex mb-6 justify-center">
                ...
                />
                <button className="bg-[#fff] p-2 rounded-r">
                    <FontAwesomeIcon icon={faPaperPlane} size="lg" color="#1D91AA" />
                </button>
            </div>
                ...
                <div className='flex flex-col items-center mb-6'>
                    ...
                    <div className={styles.footerInfoContainer}>
                        ...
                        <div className='flex items-center sm:items-start'>
                            ...
                            <button onClick={openLocation} className='text-white underline '>
